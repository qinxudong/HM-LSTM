...
losses = network.train(batches_in[:-1], batches_out[:-1], epochs=epochs, load_vars_from_disk=False,
              save_vars_to_disk=True, variable_path='weights/{}_{}epochs'.format(task, epochs))
